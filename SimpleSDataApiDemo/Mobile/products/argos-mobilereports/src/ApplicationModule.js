define('Mobile/Reports/ApplicationModule', [
    ...
    'Mobile/Reports/Views/Customer/Detail',
    'Mobile/Reports/Views/Customer/Edit',
    ...
    return dojo.declare('Mobile.Reports.ApplicationModule', [Sage.Platform.Mobile.ApplicationModule], {
        loadViews: function() {
            ...
            this.registerView(new Mobile.Reports.Views.Customer.Detail());
            this.registerView(new Mobile.Reports.Views.Customer.Edit());
